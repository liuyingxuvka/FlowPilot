...
FlowPilot intentionally does not vendor FlowGuard in this landing repository.
...
| **concept-led-ui-redesign** | Used when substantial UI redesign requires concept direction and visual review. | [liuyingxuvka/concept-led-ui-redesign-skill](https://github.com/liuyingxuvka/concept-led-ui-redesign-skill) |
| **frontend-design** | Public UI design skill used when product UI implementation and polish are in scope. | [anthropics/skills - `skills/frontend-design`](https://github.com/anthropics/skills/blob/main/skills/frontend-design/SKILL.md) |
...
FlowGuard 源仓库：[liuyingxuvka/FlowGuard](https://github.com/liuyingxuvka/FlowGuard)。FlowPilot 不会在这个 landing repository 里内置 FlowGuard。
...
| **concept-led-ui-redesign** | 当大型 UI 重设计需要概念方向和视觉审查时使用。 | [liuyingxuvka/concept-led-ui-redesign-skill](https://github.com/liuyingxuvka/concept-led-ui-redesign-skill) |
| **frontend-design** | 公开 UI 设计技能；当产品 UI 实现和 polish 在范围内时使用。 | [anthropics/skills - `skills/frontend-design`](https://github.com/anthropics/skills/blob/main/skills/frontend-design/SKILL.md) |
