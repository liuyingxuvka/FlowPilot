...
<p align="center">
  Source version: <strong>v0.2.1</strong> · MIT License · Codex skill source package
</p>
<!-- README HERO END -->
...
- Current source version in this checkout: **v0.2.1**.
...
| **flowpilot** | Required | This Codex skill. | `skills/flowpilot/` |
...
| **autonomous-concept-ui-redesign** | Optional companion | Experimental UI route that composes concept framing, frontend work, iteration, deviation review, geometry QA, screenshot QA, and final verdict. | Included in this repository |
...
| **flowpilot** | 必需 | 本 Codex 技能。 | `skills/flowpilot/` |
...
| **autonomous-concept-ui-redesign** | 可选伴随 | 实验性 UI 路线，组合概念框定、frontend work、iteration、deviation review、geometry QA、screenshot QA 和 final verdict。 | 本仓库内置 |
