...
| **autonomous-concept-ui-redesign** | Experimental default UI route that composes concept framing, concept images, frontend implementation, bounded design iteration, deviation review, geometry QA, screenshot QA, and a final verdict. | Included in this repository under `skills/autonomous-concept-ui-redesign`. |
| **concept-led-ui-redesign** | Internal dependency/fallback for concept direction and visual review inside autonomous UI routes. | [liuyingxuvka/concept-led-ui-redesign-skill](https://github.com/liuyingxuvka/concept-led-ui-redesign-skill) |
...
- heartbeat 或 manual resume 会重新加载当前执行前线，而不是从聊天历史里猜；
...
| **autonomous-concept-ui-redesign** | 实验性默认 UI 路线；组合概念设计、概念图、前端实现、有限轮设计迭代、偏差审查、几何 QA、截图 QA 和最终裁决。 | 本仓库 `skills/autonomous-concept-ui-redesign`。 |
| **concept-led-ui-redesign** | autonomous UI 路线里的内部依赖/回退，用于概念方向和视觉审查。 | [liuyingxuvka/concept-led-ui-redesign-skill](https://github.com/liuyingxuvka/concept-led-ui-redesign-skill) |
