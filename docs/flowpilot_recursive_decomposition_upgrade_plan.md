...
| 3 | Prompt cards | Require PM recursive decomposition, leaf readiness, reviewer depth review, and parent backward replay. | `pm_route_skeleton.md`, `pm_node_acceptance_plan.md`, `pm_current_node_loop.md`, reviewer/FlowGuard operator route cards | Planning-quality tests assert required language is present. |
