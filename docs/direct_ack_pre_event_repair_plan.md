...
| 5 | Preserve hard blockers | Missing, invalid, wrong-role, wrong-hash, and incomplete bundle ACKs must still block the incoming role event. | Runtime tests cover invalid/incomplete ACKs and unsupported historical record-event ACK rejection. |
