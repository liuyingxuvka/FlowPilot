...
| 5 | Retired Product Officer route events accidentally become default blockers. | System card sequence no longer delivers the Product Officer route card by default; retired direct events are rejected by current event intake. |
