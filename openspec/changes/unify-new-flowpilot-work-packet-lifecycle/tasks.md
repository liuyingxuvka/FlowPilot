...
- [x] 1.2 Add requirements for symmetric packet lifecycle across PM, explicit FlowGuard operator, Reviewer, and requested worker-class responsibilities.
...
- [x] 2.2 Make `submit-result` advance task -> FlowGuard operator -> review -> system validation -> system closure.
