...
- [x] 2.4 Add lifecycle/startup/system-card contract tests for `flowpilot_router_lifecycle_requests`, `flowpilot_router_lifecycle_support`, `flowpilot_router_startup_bootloader`, `flowpilot_router_startup_closure`, `flowpilot_router_startup_display`, `flowpilot_router_startup_fact_boundary`, `flowpilot_router_startup_flow`, `flowpilot_router_startup_intake`, `flowpilot_router_startup_role_recovery`, `flowpilot_router_startup_support`, and `flowpilot_router_system_cards_delivery`.
