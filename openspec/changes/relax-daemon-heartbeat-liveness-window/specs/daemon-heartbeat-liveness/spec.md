...
- **WHEN** the Router daemon status or lock heartbeat is at most thirty seconds old
...
- **WHEN** the Router daemon heartbeat age is greater than thirty seconds
...
- **WHEN** heartbeat age exceeds thirty seconds but the daemon process may still be alive
...
- **WHEN** heartbeat age exceeds thirty seconds before Controller has checked daemon liveness
