...
The new formal runtime is now packet-symmetric: PM, FlowGuard operator, Reviewer, Validator, and Closure officer all receive packets and complete them through the same lease/ACK/result chain. The latest live-style exercise found two remaining weak spots outside that symmetry.
