...
#### Scenario: FlowGuard operator receives a formal packet
...
- **WHEN** a FlowGuard operator runs `run_meta_checks.py` or `run_capability_checks.py` as formal packet evidence
