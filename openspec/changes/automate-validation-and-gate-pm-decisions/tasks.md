...
- [x] 1.1 Add OpenSpec requirements for system validation evidence and PM high-risk decision gates.
...
- [x] 2.4 Stage high-risk PM repair decisions until FlowGuard, reviewer, system validation, and closure pass.
- [x] 2.5 Stage high-risk PM disposition decisions until FlowGuard, reviewer, system validation, and closure pass.
- [x] 2.6 Keep low-risk PM repair/disposition decisions direct.
...
- [x] 3.3 Add tests proving high-risk PM decisions are staged and low-risk repair remains direct.
