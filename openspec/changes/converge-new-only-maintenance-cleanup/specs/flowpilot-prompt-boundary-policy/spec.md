...
recovery, FlowGuard, and sealed-body obligations when active runtime cards are
shortened for maintainability.

#### Scenario: Runtime card is shortened
- **WHEN** a runtime card is compressed for maintainability
- **THEN** required identity-boundary, runtime command, current recovery, FlowGuard
