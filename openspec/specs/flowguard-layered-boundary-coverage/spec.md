# flowguard-layered-boundary-coverage Specification

## Purpose
TBD - created by archiving change apply-layered-boundary-proof-to-flowpilot-coverage. Update Purpose after archive.
## Requirements
