# flowpilot-derived-view-registries Specification

## Purpose
TBD - created by archiving change fold-flowpilot-derived-views-and-prompt-boundaries. Update Purpose after archive.
## Requirements
