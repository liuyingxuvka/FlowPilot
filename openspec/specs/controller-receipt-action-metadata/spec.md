# controller-receipt-action-metadata Specification

## Purpose
TBD - created by archiving change separate-controller-receipt-action-metadata. Update Purpose after archive.
## Requirements
