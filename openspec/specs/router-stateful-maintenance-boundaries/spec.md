# router-stateful-maintenance-boundaries Specification

## Purpose
TBD - created by archiving change split-router-stateful-maintenance-boundaries. Update Purpose after archive.
## Requirements
