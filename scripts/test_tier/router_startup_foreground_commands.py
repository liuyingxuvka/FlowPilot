...
ROUTER_FOREGROUND_COMMANDS = (
    ...
    _unittest_k(
        ...
        patterns=(
            ...
            "user_intake_progresses_to_product_architecture_without_material_card",
        ),
    ...
    _unittest_k(
        ...
        patterns=(
            ...
            "route_memory_rejects_changed_current_source_snapshot",
            "passive_wait_projection",
            "router_daemon_tick",
            "foreground_next_waits_on_fresh_controller_action_write_lock",
            "foreground_next_waits_on_stale_lock",
            "foreground_writer_settlement_budget_starts_at_first_contention",
            "foreground_writer_retry_preserves_completed_folded_actions",
            "runtime_writer_settlement_fails_closed_when_live_lock_never_clears",
        ),
