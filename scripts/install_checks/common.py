...
REQUIRED_FILES = [
    ...
    "skills/flowpilot/assets/flowpilot_router_startup_mechanical_boundary.py",
    ...
    "skills/flowpilot/assets/flowpilot_router_action_handlers_role_binding.py",
    "skills/flowpilot/assets/flowpilot_router_action_handlers_role_misc.py",
    ...
    "skills/flowpilot/assets/flowpilot_router_controller_runtime_apply.py",
    "skills/flowpilot/assets/flowpilot_router_controller_runtime_loop.py",
    "skills/flowpilot/assets/flowpilot_router_controller_runtime_next.py",
    ...
    "simulations/flowpilot_complete_workstream_fake_ai_execution.py",
