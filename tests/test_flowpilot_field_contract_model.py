...
class FlowPilotFieldContractModelTests(unittest.TestCase):
    def test_current_field_contract_catalog_covers_startup_and_background_fields(self) -> None:
        ...
        self.assertIn("responsibility_lease.ack_received", fields)
        self.assertIn("responsibility_lease.ack_received_at", fields)
        self.assertIn("responsibility_lease.progress_count", fields)
        self.assertIn("responsibility_lease.last_progress_at", fields)
        self.assertIn("lifecycle_guard.last_liveness_evidence_kind", fields)
        self.assertNotIn("role_binding_ledger.role_slots[].host_liveness_status", fields)
        ...
        self.assertNotIn("current_role_agent_binding.host_liveness_status", fields)
        self.assertNotIn("current_role_agent_binding.liveness_decision", fields)
        self.assertIn("current_role_agent_binding.current_run_binding_decision", fields)
        self.assertIn("role_binding_ledger.role_slots[].current_run_binding_decision", fields)
    ...
    def test_field_status_catalog_marks_retired_and_forbidden_legacy(self) -> None:
        ...
        self.assertIn("current_role_agent_binding.host_liveness_status", forbidden)
        self.assertIn("current_role_agent_binding.liveness_decision", forbidden)
        self.assertIn("role_binding_ledger.role_slots[].host_liveness_status", forbidden)
        self.assertIn("role_binding_ledger.role_slots[].liveness_decision", forbidden)
        self.assertIn("role_binding_memory.current_role_agent_binding.host_liveness_status", forbidden)
        self.assertIn("responsibility_lease.liveness_status", forbidden)
        self.assertIn("responsibility_lease.last_liveness_status", forbidden)
        self.assertIn("responsibility_lease.liveness_checked_at", forbidden)
        self.assertIn("responsibility_lease.host_liveness_history", forbidden)
        self.assertIn("runtime.host_liveness_reports", forbidden)
