...
runner = load_module(
    "flowpilot_protocol_kernel_runner",
    ROOT / "simulations" / "run_flowpilot_protocol_kernel_checks.py",
)
model = load_module(
    "flowpilot_protocol_kernel_model_for_tests",
    ROOT / "simulations" / "flowpilot_protocol_kernel_model.py",
)


class FlowPilotProtocolKernelTests(unittest.TestCase):
