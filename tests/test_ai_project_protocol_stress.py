...
runner = load_module(
    "ai_project_protocol_stress_runner",
    ROOT / "simulations" / "run_ai_project_protocol_stress_checks.py",
)
model = load_module(
    "ai_project_protocol_stress_model_for_tests",
    ROOT / "simulations" / "ai_project_protocol_stress_model.py",
)


class AIProjectProtocolStressTests(unittest.TestCase):
