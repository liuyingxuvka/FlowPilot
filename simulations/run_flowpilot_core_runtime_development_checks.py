"""Run FlowGuard development-process checks for the clean AI project runtime."""
...
try:  # pragma: no cover
    from . import flowpilot_core_runtime_development_model as model
except ImportError:  # pragma: no cover
    import flowpilot_core_runtime_development_model as model


ROOT = Path(__file__).resolve().parent
RESULTS_PATH = ROOT / "flowpilot_core_runtime_development_results.json"
...
def run_checks() -> dict[str, Any]:
    ...
    rows = [
        {
            ...
            "freshness": "current",
            "scope": "routine",
            "evidence": ["simulations/flowpilot_core_runtime_development_model.py"],
        },
        {
            "id": "target_development_plan",
            "status": "passed" if target_plan["ok"] else "failed",
            "freshness": "current",
            "scope": "routine",
            "evidence": ["openspec/changes/build-black-box-flowpilot-runtime/tasks.md"],
        },
        {
            "id": "development_hazard_replay",
    ...
    return {
        "result_type": "flowpilot_core_runtime_development_checks",
