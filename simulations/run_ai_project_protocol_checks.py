"""Run FlowGuard checks for the clean AI project protocol kernel."""
...
try:  # pragma: no cover
    from . import ai_project_protocol_model as model
except ImportError:  # pragma: no cover
    import ai_project_protocol_model as model


ROOT = Path(__file__).resolve().parent
RESULTS_PATH = ROOT / "ai_project_protocol_results.json"
...
def run_checks() -> dict[str, Any]:
    ...
    report = {
        "result_type": "ai_project_protocol_kernel",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(f"[ai-project-protocol] ok={report['ok']}")
