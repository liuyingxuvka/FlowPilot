...
CONTRACT_EXHAUSTION_MUTATION_CANONICALIZATION = {
    ...
    "partial_owner_set_missing_id": "missing_required_child_field",
    "extra_owner_id": "wrong_allowed_value",
    "empty_owner_set_extra_id": "wrong_allowed_value",
    "malformed_projection_row": "wrong_type",
    "complete_owner_coverage": "corrected_second_retry",
    ...
    "control_plane_ledger_hygiene.allow_terminal_ledger_hygiene": "corrected_second_retry",
    "control_plane_ledger_hygiene.block_final_reviewer_authorization_gap": "missing_authorized_read",
    "control_plane_ledger_hygiene.block_terminal_active_or_stopped_blocker": "dirty_terminal",
    "control_plane_ledger_hygiene.block_terminal_break_glass_not_closed": "dirty_terminal",
    "control_plane_ledger_hygiene.block_terminal_failed_or_unreviewed_result": "dirty_terminal",
    "control_plane_ledger_hygiene.continue_current_runtime_path": "corrected_second_retry",
    "control_plane_ledger_hygiene.reject_dirty_accepted_result_pointer": "accepted_result_work_order_split",
    "control_plane_ledger_hygiene.reject_inconsistent_clean_accepted_pointer": "accepted_result_work_order_split",
    "control_plane_ledger_hygiene.reject_repair_identity_discontinuity": "wrong_owner",
    "control_plane_ledger_hygiene.require_review_or_validation_before_acceptance": "missing_stage_evidence_matrix",
    "global_standard_context.flowguard_local_only_model": "missing_evidence_manifest",
    "global_standard_context.node_plan_local_only_references": "missing_evidence_manifest",
    "global_standard_context.worker_local_only_completion": "stage_evidence_mismatch",
    "review_packet.result_ids_tail_after_accepted_result": "accepted_result_work_order_split",
    "reviewer.prompt_omits_active_verification": "missing_evidence_manifest",
    "reviewer.semantic_keyword_gate_attempt": "wrong_owner",
    "reviewer_generic_optimization_only": "wrong_owner",
    "reviewer_honest_missing_substitute_blocks": "missing_evidence_manifest",
    "reviewer_partial_deliverable_count_blocks": "missing_required_field",
    "reviewer_reachable_only_downgrade_blocks": "stage_evidence_mismatch",
    "reviewer_stage_specific_challenge_pass": "corrected_second_retry",
    "reviewer_status_only_closure_blocks": "dirty_terminal",
    "reviewer_weaker_child_skill_output_blocks": "stage_evidence_mismatch",
    "submit_result.accepted_packet_resubmit": "duplicate_packet",
    "submit_result.closed_lease_submit": "lease_expired",
    "submit_result.duplicate_current_lease_submit": "duplicate_packet",
    "submit_result.noncurrent_packet_submit": "stale_id",
    "submit_result.stale_route_submit": "stale_id",
