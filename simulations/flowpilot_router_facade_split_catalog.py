...
ROUTER_FACADE_PARTITIONS = (
    ...
    StructurePartitionItem(
        ...
        old_path="flowpilot_router hand-written private unsupported_historical wrappers",
    ...
    StructurePartitionItem(
        ...
        new_path="flowpilot_router_facade_export_manifest unsupported_historical wrappers",
    ),
    StructurePartitionItem(
    ...
    StructurePartitionItem(
        "startup_lifecycle_resume_prompt",
        item_type="prompt",
        owner_module_id="prompt_delivery",
    ...
    StructurePartitionItem(
        ...
        new_path="flowpilot_router_io unsupported_historical facade",
    ),
    StructurePartitionItem(
        "router_io_paths",
        item_type="function_cluster",
    ...
    StructurePartitionItem(
        ...
        item_type="function_cluster",
        owner_module_id="startup_mechanical_boundary",
        old_path="flowpilot_router_startup_flow startup fact and boundary audit bodies",
        new_path="flowpilot_router_startup_mechanical_boundary",
    ),
    StructurePartitionItem(
        "self_interrogation",
        item_type="function_cluster",
    ...
    StructurePartitionItem(
        ...
        old_path="flowpilot_router_lifecycle_requests terminal controller-work fence helpers",
...
ROUTER_FACADE_MODULES = (
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("canonical owner export registry", "public export allowlist authority"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        owns_config=("owner_export_manifest",),
        dependencies=("facade_export_registry",),
        behavior_contracts=("unsupported_historical owner export manifest import unsupported_historical",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("action-domain owner export unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("controller-domain owner export unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("route-domain owner export unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("startup-domain owner export unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("terminal/work-packet owner export unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        layer="parent",
        owns_functions=(),
        dependencies=("controller_runtime_loop", "router_facade"),
        behavior_contracts=("controller runtime facade exports", "router skeleton binding propagation"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "controller_runtime_loop",
        path="skills/flowpilot/assets/flowpilot_router_controller_runtime_loop.py",
        layer="parent",
        owns_functions=(),
        dependencies=("controller_runtime_next", "controller_runtime_apply", "router_facade"),
        behavior_contracts=("controller runtime loop facade exports", "child owner binding propagation"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "controller_runtime_next",
        path="skills/flowpilot/assets/flowpilot_router_controller_runtime_next.py",
        owns_functions=(
            "next_action",
            "compute_controller_action",
        ),
        owns_state=("controller_next_action_loop",),
        dependencies=("action_factory", "action_providers", "router_facade"),
        behavior_contracts=("next action loop", "legal controller action computation"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "controller_runtime_apply",
        ...
        owns_state=("controller_apply_loop",),
        dependencies=("action_handlers", "controller_runtime_next", "event_dispatcher", "router_facade"),
        behavior_contracts=("controller apply loop", "external event entrypoint", "safe run-until-wait folding"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        owns_functions=("write_role_output_envelope", "_try_reconcile_direct_role_output_event_ledger"),
        owns_state=("role_output_bridge_records",),
        dependencies=("role_output_runtime", "system_cards", "router_facade"),
        behavior_contracts=("role output envelope bridge", "direct current role-output reconciliation", "prompt delivery context repair"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        owns_functions=("_write_manual_resume_binding", "_reset_resume_cycle_for_wakeup"),
        owns_state=("lifecycle_support_records",),
        dependencies=("lifecycle_requests", "router_facade"),
        behavior_contracts=("legacy Router wake binding write", "resume cycle reset", "lifecycle record paths"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        owns_functions=("_sync_model_gate_flags", "_require_single_active_model_miss_review_block"),
    ...
    ModuleStructureEvidence(
        ...
        owns_functions=("card_checkin_instruction", "controller_table_prompt", "startup_lifecycle_resume_prompt"),
        behavior_contracts=("card ACK instruction", "controller table prompt", "lifecycle resume prompt rendering"),
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("ledger path unsupported_historical", "scheduler progress projection", "facade wrappers"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("low-level IO unsupported_historical facade", "unsupported_historical import surface"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        dependencies=("router_facade",),
        behavior_contracts=("run state shape", "bootstrap state persistence", "runtime state unsupported_historical wrappers"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        owns_functions=(),
        owns_state=(),
        dependencies=("startup_bootloader", "startup_intake", "startup_display", "startup_role_recovery", "startup_closure", "startup_mechanical_boundary"),
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("legacy Router resume action selection", "role assignment/replacement persistence", "continuation binding records"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        owns_state=("startup_closure_reconciliation", "legacy_router_wake_binding"),
        dependencies=("lifecycle_support", "terminal_ledger", "router_facade"),
        behavior_contracts=("startup closure reconciliation", "legacy Router wake-binding readiness", "dirty closure invalidation"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "startup_mechanical_boundary",
        path="skills/flowpilot/assets/flowpilot_router_startup_mechanical_boundary.py",
        owns_functions=("_next_startup_mechanical_audit_action", "_write_startup_mechanical_audit"),
        owns_state=("startup_mechanical_audit", "controller_boundary_confirmation"),
        dependencies=("controller_boundary", "role_output_bridge", "router_facade"),
        behavior_contracts=("startup mechanical audit", "controller boundary confirmation", "mechanical audit repair actions"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("controller_ledger", "router_facade"),
        behavior_contracts=("controller receipt reconciliation", "scheduler row lifecycle", "standby/patrol status unsupported_historical"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        "action_handlers_roles",
        path="skills/flowpilot/assets/flowpilot_router_action_handlers_roles.py",
        layer="parent",
        owns_functions=(),
        dependencies=("action_handlers_role_binding", "action_handlers_role_misc", "action_handlers_resume", "router_facade"),
        behavior_contracts=("role-facing action handler facade exports",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "action_handlers_role_binding",
        ...
        owns_state=("current_role_agent_binding", "role_binding_ledger", "role_io_protocol_injections"),
        dependencies=("role_io_protocol", "startup_role_recovery", "router_facade"),
        behavior_contracts=("current on-demand role binding", "role I/O protocol injection"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "action_handlers_role_misc",
        ...
        owns_state=("mail_delivery_postconditions", "controller_repair_work_packet_results", "display_surface_status"),
        dependencies=("controller_repair", "startup_display", "events_repair", "router_facade"),
        behavior_contracts=("mail delivery fold", "controller repair work packet result", "display and blocker handlers"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "action_handlers_resume",
        ...
        owns_state=("resume_reentry", "role_recovery_report", "role_rehydration_report"),
        dependencies=("startup_role_recovery", "runtime_state", "router_facade"),
        behavior_contracts=("current-run resume evidence load", "role rehydration", "targeted role recovery"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("lifecycle request unsupported_historical facade", "child router binding"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("router_facade", "controller_scheduler", "daemon_runtime"),
    ...
    ModuleStructureEvidence(
        ...
        dependencies=("events_repair", "router_facade"),
    ...
    ModuleStructureEvidence(
        ...
        dependencies=("events_repair", "runtime_state", "router_facade"),
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("external event dispatch unsupported_historical", "wait-action settlement", "event finalizer delegation"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        owns_functions=("_node_acceptance_traceability_issues", "_final_ledger_traceability_issues"),
        dependencies=("terminal_ledger", "router_facade"),
        behavior_contracts=("final ledger traceability facade and source-of-truth entry exports",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "terminal_ledger_flowguard_coverage",
        path="skills/flowpilot/assets/flowpilot_router_terminal_ledger_flowguard_coverage.py",
        owns_functions=(
        ...
        owns_state=("flowguard_terminal_coverage_closure",),
        dependencies=("terminal_ledger_traceability", "router_facade"),
        behavior_contracts=("terminal FlowGuard coverage report and PM closure validation",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        "terminal_ledger_writer",
        path="skills/flowpilot/assets/flowpilot_router_terminal_ledger_writer.py",
        owns_functions=("_write_final_route_wide_ledger",),
        owns_side_effects=("final_route_wide_ledger_write", "terminal_human_backward_replay_map_write"),
        dependencies=("terminal_ledger_traceability", "terminal_ledger_flowguard_coverage", "router_facade"),
        behavior_contracts=("final route-wide ledger persistence and replay-map preparation",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        dependencies=("terminal_ledger", "router_facade"),
        behavior_contracts=("terminal status recovery and unsupported_historical material packet repair",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
)
