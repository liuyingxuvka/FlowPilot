...
ROUTER_STRUCTURE_PARTITIONS = (
    ...
    StructurePartitionItem(
        ...
        old_path="flowpilot_router hand-written unsupported_historical wrappers",
    ...
    StructurePartitionItem(
        ...
        new_path="flowpilot_router_facade_export_manifest_* unsupported_historical views",
    ),
    StructurePartitionItem(
    ...
    StructurePartitionItem(
        ...
        description="The unsupported_historical IO module stays import-compatible while behavior moves to focused child owners.",
    ),
    StructurePartitionItem(
        "router_io_paths",
        item_type="function_cluster",
...
ROUTER_STRUCTURE_MODULES = (
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("unsupported_historical owner lookup registry import unsupported_historical",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("action export manifest unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("controller export manifest unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("route export manifest unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("startup export manifest unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
        ...
        dependencies=("facade_export_registry",),
        behavior_contracts=("terminal/work-packet export manifest unsupported_historical view",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("startup mechanical audit", "mechanical-boundary audit"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
    ),
    ModuleStructureEvidence(
        "protocol_catalog",
    ...
    ModuleStructureEvidence(
        ...
        owns_side_effects=(),
        dependencies=("router_facade",),
        behavior_contracts=("controller action and receipt reconciliation unsupported_historical",),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
    ...
    ModuleStructureEvidence(
        ...
        owns_state=("pm_role_work_index", "flowguard_operator_request_lifecycle"),
        dependencies=("router_facade",),
