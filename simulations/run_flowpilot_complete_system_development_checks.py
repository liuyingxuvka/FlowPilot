"""Run FlowGuard development-process checks for the complete FlowPilot system."""
...
try:  # pragma: no cover
    from . import flowpilot_complete_system_development_model as model
except ImportError:  # pragma: no cover
    import flowpilot_complete_system_development_model as model


ROOT = Path(__file__).resolve().parent
RESULTS_PATH = ROOT / "flowpilot_complete_system_development_results.json"
...
def _target_plan_report() -> dict[str, Any]:
    ...
    return {
        ...
        "evidence_role": "modeled_target_path_not_execution_proof",
        "failures": failures,
...
def run_checks() -> dict[str, Any]:
    ...
    rows = [
        {
            "id": "complete_development_flowguard_model",
            "status": "passed" if flowguard["ok"] else "failed",
            "freshness": "current",
            "scope": "routine",
            "evidence": ["simulations/flowpilot_complete_system_development_model.py"],
        },
        {
            "id": "complete_target_development_plan",
            "status": "passed" if target_plan["ok"] else "failed",
            "freshness": "current",
            "scope": "routine",
            "evidence": ["openspec/changes/complete-black-box-flowpilot-system/tasks.md"],
        },
        {
            "id": "complete_development_hazard_replay",
    ...
    return {
        "result_type": "flowpilot_complete_system_development_checks",
