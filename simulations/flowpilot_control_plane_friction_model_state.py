...
class State:
    ...
    active_blocker_points_noncurrent_packet: bool = False
    current_target_gate_blocks_stale_target: bool = True
    blocked_pm_repair_decision_packet_seen: bool = False
    blocked_pm_repair_decision_packet_reused: bool = False
    fresh_pm_repair_decision_packet_issued: bool = True
    fallback_responsibility_used: bool = False
    staged_effect_same_family_repeated: bool = False
    same_family_expansion_stopped: bool = True
    ...
    model_miss_flowguard_operator_report_complete: bool = False
