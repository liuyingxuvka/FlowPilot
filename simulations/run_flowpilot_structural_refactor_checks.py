...
REQUIRED_LABELS = (
    ...
    "start_duplicate_wrappers_slice",
    "start_packet_runtime_slice",
    "start_install_check_tooling_slice",
    "start_meta_model_phases_slice",
    "start_capability_model_phases_slice",
    "start_router_event_intake_slice",
    "start_router_action_apply_slice",
    "start_router_runtime_tests_slice",
    ...
    "commit_local_main_without_release",
...
HAZARD_EXPECTED_FAILURES = {
    ...
    "local_git_sync_before_privacy_check": "local git sync happened before public-boundary privacy check",
    "local_git_sync_with_extra_work_branch": "local git sync finished while an extra local work branch still existed",
