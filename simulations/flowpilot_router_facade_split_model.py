...
def router_facade_testmesh_plan() -> TestMeshPlan:
    return TestMeshPlan(
        ...
        partition_items=(
            ...
            TestPartitionItem("startup_mechanical_boundary", owner_suite_id="startup_runtime"),
            ...
            TestPartitionItem("terminal_ledger_flowguard_coverage", owner_suite_id="terminal_runtime"),
            TestPartitionItem("terminal_ledger_writer", owner_suite_id="terminal_runtime"),
        ...
        target_split_derivation=TestTargetSplitDerivation(
            ...
            covered_partition_item_ids=(
                ...
                "terminal_ledger_flowguard_coverage",
                "terminal_ledger_writer",
