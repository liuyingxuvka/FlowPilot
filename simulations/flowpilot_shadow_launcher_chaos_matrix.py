...
SHADOW_LAUNCHER_CHAOS_ROWS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "fake_ai_artifacts": ["manual_resume_event", "resume_reentry", "background_artifacts"],
    ...
    },
    {
        ...
        "expected_standard_state": "bad_packages_blocked_or_quarantined_without_startup_runtime_ready",
        ...
        "required_evidence": [
            ...
            "startup_runtime_ready_not_falsely_recorded",
        ],
