...
HAZARD_EXPECTED_FAILURES = {
    ...
    "active_holder_lease_without_current_binding": "active holder lease was issued without concrete agent identity, current binding evidence, and packet-role match",
    "active_holder_lease_to_wrong_packet_role": "active holder lease was issued without concrete agent identity, current binding evidence, and packet-role match",
