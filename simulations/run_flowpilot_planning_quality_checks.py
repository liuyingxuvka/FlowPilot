...
HAZARD_EXPECTED_FAILURES = {
    ...
    model.INITIAL_ROUTE_MEGA_ROOT: "initial route collapsed the project into one top-level mega-root that defers useful decomposition",
    model.INITIAL_ROUTE_MICRO_GATE_BLOAT: "initial route expanded mechanical handoffs into top-level micro-gates without independent outcomes",
    model.INITIAL_ROUTE_NEAR_TERM_VAGUE: "initial route leaves the nearest nodes too vague to execute and verify",
    model.INITIAL_ROUTE_FAR_ROUTE_OVERDETAILED: "initial route over-specifies distant work instead of preserving proportionate uncertainty",
