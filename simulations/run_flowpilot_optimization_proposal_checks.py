...
HAZARD_EXPECTED_FAILURES = {
    ...
    "router_reset_missing_policy_hash": "router-owned controller receipt lacked core delivery, policy hash, role confirmation, or startup runtime mechanical audit",
    "router_reset_without_startup_runtime_audit": "router-owned controller receipt lacked core delivery, policy hash, role confirmation, or startup runtime mechanical audit",
