...
ROUTER_TEST_PARTITIONS = (
    ...
    TestPartitionItem("terminal_ledger_summary", owner_suite_id="router_terminal"),
    TestPartitionItem("terminal_ledger_traceability", owner_suite_id="router_terminal"),
    TestPartitionItem("terminal_ledger_closure", owner_suite_id="router_closure"),
    TestPartitionItem("terminal_ledger_recovery", owner_suite_id="router_terminal"),
    ...
    TestPartitionItem("pm_role_work_gates", owner_suite_id="router_pm_role_work"),
    TestPartitionItem("pm_role_work_writes", owner_suite_id="router_pm_role_work"),
    TestPartitionItem("pm_role_work_lifecycle", owner_suite_id="router_pm_role_work"),
    TestPartitionItem("pm_role_work_actions", owner_suite_id="router_pm_role_work"),
