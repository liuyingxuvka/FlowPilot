...
ROUTER_STRUCTURE_PARTITIONS = (
    StructurePartitionItem(
        ...
        ownership="parent",
        description="Root run-state coordination and final persistence remain in the facade.",
    ),
    StructurePartitionItem(
...
ROUTER_STRUCTURE_MODULES = (
    ModuleStructureEvidence(
        ...
        layer="parent",
        owns_functions=("main", "reconcile_current_run", "validate_artifact"),
        owns_state=("route_state_root",),
        behavior_contracts=("public imports", "CLI", "final persistence"),
...
ROUTER_TEST_PARTITIONS = (
    ...
    TestPartitionItem("route_mutation_core", owner_suite_id="router_route_mutation_core"),
...
ROUTER_TEST_SUITES = (
    ...
    TestSuiteEvidence(
        ...
        command="python -m unittest -v tests.router_runtime.route_mutation",
        result_status=TEST_STATUS_PASSED,
        evidence_tier=EVIDENCE_CONFORMANCE_GREEN,
        test_count=22,
        selected_count=22,
        exit_code=0,
        result_path="tmp/flowguard_background/router_route_mutation_core.exit.txt",
        log_root="tmp/flowguard_background",
        background=True,
        owns_state=("route_mutation_core",),
    ),
    TestSuiteEvidence(
