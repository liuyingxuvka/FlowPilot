...
CURRENT_FIELD_CONTRACTS = (
    ...
    {
        "field": "current_handoff_contract.required_report_contract.forbidden_result_body_fields",
        "logical_field": "forbidden_fields_seen",
        "layer": "middle",
        "owner": "flowpilot_router",
        "status": "mechanical_runtime_owned",
        "validator": "_current_result_submission_contract_violation",
        "required_value": "same_forbidden_fields_as_packet_result_contract_row",
        "unlocks": "role_avoids_unsupported_old_fields",
    },
    {
    ...
    {
        "field": "preplanning.high_standard_contract.requirements[].closure_blocking",
        "logical_field": "high_standard_requirement_closure_blocking",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_high_standard_requirements",
    ...
    },
    {
        ...
        "logical_field": "preplanning_material_sources",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_discovery_result",
        "required_value": "non_empty_list",
        "unlocks": "preplanning_discovery_acceptance",
    },
    {
        "field": "preplanning.discovery.material_sufficiency",
        "logical_field": "preplanning_material_sufficiency",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_discovery_result",
    ...
    {
        "field": "preplanning.discovery.local_skill_inventory",
        "logical_field": "preplanning_local_skill_inventory",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_discovery_result",
    ...
    {
        "field": "preplanning.discovery.candidate_only_skill_policy",
        "logical_field": "preplanning_candidate_only_skill_policy",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_discovery_result",
    ...
    {
        "field": "preplanning.skill_standard.obligations[].evidence_required",
        "logical_field": "skill_standard_obligation_evidence_required",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_skill_obligations",
    ...
    {
        "field": "preplanning.skill_standard.obligations[].closure_blocking",
        "logical_field": "skill_standard_obligation_closure_blocking",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_parse_skill_obligations",
    ...
    {
        "field": "packet_result.review.independent_challenge",
        "logical_field": "review_packet_result_independent_challenge",
        "layer": "leaf",
        "owner": "human_like_reviewer",
        "status": "reviewer_quality_owned",
        "validator": "_json_payload_contract_check",
        "required_value": "current_nested_challenge_object",
    ...
    },
    {
        ...
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_flowguard_evidence_consistency_violation",
    ...
    {
        "field": "packet_result.flowguard_check.evidence_consistency.self_check_passed",
        "logical_field": "flowguard_evidence_consistency_self_check_passed",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_flowguard_evidence_consistency_violation",
        "required_value": "true_when_flowguard_result_can_be_accepted",
        "unlocks": "flowguard_pass_or_block_outcome",
    },
    {
        "field": "packet_result.flowguard_check.evidence_consistency.child_reports_all_passed",
        "logical_field": "flowguard_evidence_consistency_child_reports_all_passed",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_flowguard_evidence_consistency_violation",
        "required_value": "boolean_hard_child_report_status",
        "unlocks": "review_packet_release_only_when_true_for_pass",
    },
    {
        "field": "packet_result.flowguard_check.evidence_consistency.blocking_child_reports[]",
        "logical_field": "flowguard_evidence_consistency_blocking_child_reports",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_flowguard_evidence_consistency_violation",
        "required_value": "explicit_array_of_blocking_child_reports",
        "unlocks": "flowguard_block_or_reissue_before_reviewer",
    },
    {
        "field": "packet_result.flowguard_check.evidence_consistency.hard_evidence_decision",
        "logical_field": "flowguard_evidence_consistency_hard_evidence_decision",
        "layer": "leaf",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_flowguard_evidence_consistency_violation",
        "required_value": "pass_only_when_child_hard_evidence_allows_pass",
        "unlocks": "flowguard_pass_or_block_outcome",
    },
    {
        ...
        "status": "mechanical_runtime_owned",
        "validator": "_record_flowguard_from_packet_result",
        "required_value": "derived_after_evidence_consistency_gate",
        "unlocks": "matching_flowguard_report_for_review",
    },
    {
        "field": "review_packet.matching_flowguard_result_id",
        "logical_field": "review_packet_matching_flowguard_result_id",
        "layer": "middle",
        "owner": "flowpilot_core_runtime",
        "status": "mechanical_runtime_owned",
        "validator": "_has_matching_flowguard_report",
...
FIELD_LIFECYCLE_CHAINS = (
    ...
    {
        "chain_id": "flowguard_evidence_consistency_to_reviewer_handoff_chain",
        "source": "child_flowguard_or_model_test_report.hard_status",
        "field_sequence": (
            "packet_result.flowguard_check.evidence_consistency.self_check_passed",
            "packet_result.flowguard_check.evidence_consistency.child_reports_all_passed",
            "packet_result.flowguard_check.evidence_consistency.blocking_child_reports[]",
            ...
            "review_packet.matching_flowguard_result_id",
        ),
        "mechanical_gate": "_flowguard_evidence_consistency_violation",
        "human_quality_gate": "_record_review_from_packet_result",
        "terminal_disposition": "packet_result.status",
        "no_prose_authority": True,
        "no_reviewer_mechanical_field_check": True,
