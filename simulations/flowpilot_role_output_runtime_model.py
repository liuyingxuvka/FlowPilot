...
FORBIDDEN_LEGACY_STARTUP_ACTIVATION_APPROVAL = "forbidden_legacy_startup_activation_approval"
...
VALID_PM_PACKAGE_RESULT_DISPOSITION = "valid_pm_package_result_disposition"
...
VALID_SCENARIOS = (
    ...
    VALID_PM_PACKAGE_RESULT_DISPOSITION,
)

NEGATIVE_SCENARIOS = (
    FORBIDDEN_LEGACY_STARTUP_ACTIVATION_APPROVAL,
...
LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT = OutputContract(
...
PM_PACKAGE_RESULT_DISPOSITION_CONTRACT = OutputContract(
...
CONTRACTS_BY_SCENARIO = {
    ...
    FORBIDDEN_LEGACY_STARTUP_ACTIVATION_APPROVAL: LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT,
    ...
    VALID_PM_PACKAGE_RESULT_DISPOSITION: PM_PACKAGE_RESULT_DISPOSITION_CONTRACT,
    MISSING_REGISTRY_RUNTIME_BINDING: LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT,
    REGISTRY_CONTRACT_ID_MISMATCH: LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT,
    REGISTRY_ALLOWED_ROLE_MISMATCH: LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT,
    REGISTRY_ROUTER_EVENT_MISSING: LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT,
    UNREGISTERED_RUNTIME_OUTPUT_TYPE: LEGACY_STARTUP_ACTIVATION_APPROVAL_CONTRACT,
...
def _router_rejection_reason(state: State) -> str:
    if state.scenario == FORBIDDEN_LEGACY_STARTUP_ACTIVATION_APPROVAL:
        return "forbidden_legacy_output_type"
