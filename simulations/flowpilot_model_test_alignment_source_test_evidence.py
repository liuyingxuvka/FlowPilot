...
def source_test_evidence() -> tuple[TestEvidence, ...]:
    ...
    return (
        ...
        _evidence(
            "source.startup.legacy_role_gates_unsupported",
        ...
        _evidence(
            ...
            test_name="test_blackbox_fake_project_rehearsal_smoke_uses_public_cli",
        ...
        _evidence(
            "source.new_entrypoint.blackbox_rehearsal_negative",
            test_name="test_blackbox_fake_project_rehearsal_smoke_uses_public_cli",
            path="tests/test_flowpilot_fake_project_rehearsal.py",
            command="python -m unittest tests.test_flowpilot_fake_project_rehearsal.FlowPilotFakeProjectRehearsalTests.test_blackbox_fake_project_rehearsal_smoke_uses_public_cli",
            test_kind=NEGATIVE,
        ...
        _evidence(
            "source.new_entrypoint.blackbox_rehearsal_edge",
            test_name="test_blackbox_fake_project_rehearsal_smoke_uses_public_cli",
            path="tests/test_flowpilot_fake_project_rehearsal.py",
            command="python -m unittest tests.test_flowpilot_fake_project_rehearsal.FlowPilotFakeProjectRehearsalTests.test_blackbox_fake_project_rehearsal_smoke_uses_public_cli",
            test_kind=EDGE,
        ...
        _evidence(
            "source.new_entrypoint.no_shortcut",
            test_name="test_ack_only_and_pm_only_result_do_not_reach_terminal_closure",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_ack_only_and_pm_only_result_do_not_reach_terminal_closure",
            test_kind=NEGATIVE,
            covers=(
        ...
        _evidence(
            "source.new_entrypoint.flowguard_packet",
            test_name="test_flowguard_operator_is_leased_through_its_own_packet",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_flowguard_operator_is_leased_through_its_own_packet",
            test_kind=NEGATIVE,
        ...
        _evidence(
            "source.new_entrypoint.flowguard_run_local_packet",
            test_name="test_flowguard_operator_is_leased_through_its_own_packet",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_flowguard_operator_is_leased_through_its_own_packet",
            test_kind=HAPPY,
            covers=("new_entrypoint.flowguard_run_local_evidence",),
            code_contracts=("flowpilot_new.submit_result",),
        ),
        _evidence(
            "source.new_entrypoint.reviewer_clean_projection",
            test_name="test_reviewer_packet_lease_projection_is_clean_before_and_after_review",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_reviewer_packet_lease_projection_is_clean_before_and_after_review",
            test_kind=EDGE,
        ...
        _evidence(
            "source.new_entrypoint.side_command_surface",
            test_name="test_formal_public_surface_omits_unsupported_side_command_paths",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_formal_public_surface_omits_unsupported_side_command_paths",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.side_command_surface_unsupported",),
            code_contracts=("flowpilot_new.main",),
        ),
        _evidence(
            "source.new_entrypoint.host_kind_menu",
            test_name="test_formal_public_surface_omits_unsupported_side_command_paths",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_formal_public_surface_omits_unsupported_side_command_paths",
            test_kind=HAPPY,
            covers=("new_entrypoint.host_kind_value_menu",),
            code_contracts=("flowpilot_new.main",),
        ),
        _evidence(
            "source.new_entrypoint.host_kind_reject",
            test_name="test_invalid_host_kind_is_rejected_instead_of_normalized",
            path="tests/test_flowpilot_new_entrypoint.py",
            command="python -m unittest tests.test_flowpilot_new_entrypoint.FlowPilotNewEntrypointTests.test_invalid_host_kind_is_rejected_instead_of_normalized",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.host_kind_value_menu",),
            code_contracts=("flowpilot_new.main",),
        ),
        _evidence(
            "source.new_entrypoint.lifecycle_guard_nonterminal",
            test_name="test_nonterminal_status_blocks_controller_stop_and_persists_guard",
            path="tests/test_flowpilot_lifecycle_guard.py",
            command="python -m unittest tests.test_flowpilot_lifecycle_guard.FlowPilotLifecycleGuardTests.test_nonterminal_status_blocks_controller_stop_and_persists_guard",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.lifecycle_guard_stop_authority",),
            code_contracts=(
                "flowpilot_new.status",
        ...
        _evidence(
            "source.new_entrypoint.lifecycle_guard_terminal",
            test_name="test_terminal_fake_e2e_allows_controller_stop",
            path="tests/test_flowpilot_lifecycle_guard.py",
            command="python -m unittest tests.test_flowpilot_lifecycle_guard.FlowPilotLifecycleGuardTests.test_terminal_fake_e2e_allows_controller_stop",
            test_kind=HAPPY,
            covers=("new_entrypoint.lifecycle_guard_stop_authority",),
            code_contracts=("flowpilot_new.status",),
        ),
        _evidence(
            "source.new_entrypoint.lifecycle_guard_resume",
            test_name="test_manual_resume_rehydrates_wait_state_from_current_run",
            path="tests/test_flowpilot_lifecycle_guard.py",
        ...
        _evidence(
            "source.new_entrypoint.lifecycle_guard_stale_result",
            test_name="test_inactive_lease_result_is_rejected_before_result_allocation",
            path="tests/test_flowpilot_lifecycle_guard.py",
            command="python -m unittest tests.test_flowpilot_lifecycle_guard.FlowPilotLifecycleGuardTests.test_inactive_lease_result_is_rejected_before_result_allocation",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.lifecycle_guard_stale_result_quarantine",),
            code_contracts=("flowpilot_new.submit_result",),
        ),
        _evidence(
            "source.new_entrypoint.lifecycle_guard_late_result",
            test_name="test_late_result_after_route_mutation_is_rejected_before_result_allocation",
            path="tests/test_flowpilot_lifecycle_guard.py",
            command="python -m unittest tests.test_flowpilot_lifecycle_guard.FlowPilotLifecycleGuardTests.test_late_result_after_route_mutation_is_rejected_before_result_allocation",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.lifecycle_guard_stale_result_quarantine",),
            code_contracts=("host.submit_host_result",),
        ),
        _evidence(
            "source.thin_parent.meta_json_out",
            test_name="test_meta_runner_json_out_keeps_canonical_result_unchanged",
            path="tests/test_flowpilot_thin_parent_checks.py",
            command="python -m unittest tests.test_flowpilot_thin_parent_checks.FlowPilotThinParentChecksTests.test_meta_runner_json_out_keeps_canonical_result_unchanged",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.flowguard_run_local_evidence",),
            code_contracts=("meta_checks_runner.run_local_json_out",),
        ),
        _evidence(
            "source.thin_parent.capability_json_out",
            test_name="test_capability_runner_json_out_keeps_canonical_result_unchanged",
            path="tests/test_flowpilot_thin_parent_checks.py",
            command="python -m unittest tests.test_flowpilot_thin_parent_checks.FlowPilotThinParentChecksTests.test_capability_runner_json_out_keeps_canonical_result_unchanged",
            test_kind=NEGATIVE,
            covers=("new_entrypoint.flowguard_run_local_evidence",),
            code_contracts=("capability_checks_runner.run_local_json_out",),
        ),
        _evidence(
        ...
        _evidence(
            ...
            code_contracts=("daemon.run_router_daemon",),
        ),
        _evidence(
        ...
        _evidence(
            "source.resume.action_handlers_direct",
            test_name="test_resume_action_handler_child_module_direct_contracts",
            path="tests/test_flowpilot_router_owner_contracts.py",
            command="python -m unittest tests.test_flowpilot_router_owner_contracts.FlowPilotRouterOwnerContractTests.test_resume_action_handler_child_module_direct_contracts",
            test_kind=EDGE,
            covers=("resume.current_run_reentry",),
            code_contracts=(
        ...
        _evidence(
            "source.router_owner.controller_runtime_facade",
            test_name="test_controller_runtime_facade_binds_loop_owner",
            path="tests/test_flowpilot_router_owner_contracts.py",
            command="python -m unittest tests.test_flowpilot_router_owner_contracts.FlowPilotRouterOwnerContractTests.test_controller_runtime_facade_binds_loop_owner",
            test_kind=HAPPY,
            covers=("runtime_owner.router_owner_external_contracts",),
            code_contracts=("controller_runtime.bind_router", "controller_runtime_loop.bind_router"),
        ),
        _evidence(
            "source.router_owner.role_binding_direct",
            test_name="test_role_binding_child_module_records_current_agent",
            path="tests/test_flowpilot_router_owner_contracts.py",
            command="python -m unittest tests.test_flowpilot_router_owner_contracts.FlowPilotRouterOwnerContractTests.test_role_binding_child_module_records_current_agent",
            test_kind=HAPPY,
            covers=("runtime_owner.router_owner_external_contracts",),
            code_contracts=("action_handlers_role_binding.write_current_role_agent_binding",),
        ),
        _evidence(
            "source.owner_contracts.lifecycle_startup_direct_helpers",
            test_name="test_lifecycle_startup_owner_helpers_execute_direct_contracts",
            path="tests/test_flowpilot_router_owner_contracts.py",
            command="python -m unittest tests.test_flowpilot_router_owner_contracts.FlowPilotRouterOwnerContractTests.test_lifecycle_startup_owner_helpers_execute_direct_contracts",
            test_kind=NEGATIVE,
            covers=("runtime_owner.lifecycle_startup_direct_helper_boundary",),
            code_contracts=(
        ...
        _evidence(
            ...
            test_name="test_coarse_owner_bind_router_is_idempotent_without_overwriting_owner_locals",
            path="tests/test_flowpilot_router_boundaries.py",
            command="python -m unittest tests.test_flowpilot_router_boundaries.FlowPilotRouterBoundaryTests.test_coarse_owner_bind_router_is_idempotent_without_overwriting_owner_locals",
            test_kind=HAPPY,
            covers=("runtime_owner.router_boundary_helpers",),
