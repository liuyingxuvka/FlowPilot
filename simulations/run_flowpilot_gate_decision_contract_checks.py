...
HAZARD_EXPECTED_FAILURES = {
    ...
    model.PRODUCT_WITHOUT_FLOWGUARD: "product/state GateDecision lacks product-scope FlowGuard proof",
    model.MIXED_WITHOUT_REVIEWER: "mixed product/visual GateDecision lacks both proof paths",
    model.DOCUMENTATION_FORCED_PRODUCT_FLOWGUARD: "documentation-only GateDecision was forced through product-scope FlowGuard",
