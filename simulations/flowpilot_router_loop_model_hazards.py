...
def _active_packet_loop(**changes: object) -> State:
    base = State(
        ...
        flowguard_operator_packet_card_delivered=True,
        ...
        flowguard_operator_result_ledger_checked=True,
        flowguard_operator_result_routed_to_pm=True,
...
def hazard_states() -> dict[str, State]:
    hazards = {
        ...
        "flowguard_operator_packet_card_before_route_activation": State(
            status="running",
            controller_boundary_confirmed=True,
            flowguard_operator_packet_card_delivered=True,
        ),
        "flowguard_operator_packet_card_before_lifecycle_flags": State(
            status="running",
            controller_boundary_confirmed=True,
            route_version=1,
            route_activated=True,
        ...
        "flowguard_operator_packet_relayed_without_flowguard_operator_card": State(
            status="running",
            controller_boundary_confirmed=True,
            route_version=1,
            route_activated=True,
        ...
        "flowguard_operator_result_routed_without_ledger_check": State(
            status="running",
            controller_boundary_confirmed=True,
            route_version=1,
            route_activated=True,
