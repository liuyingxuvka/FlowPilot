...
def _state_id(state: model.State) -> str:
    return (
        ...
        f"ledger_hygiene={state.terminal_ledger_hygiene_clean}|dirty_pointer_absent={state.dirty_accepted_pointers_absent}|"
        f"active_blocker_absent={state.stale_active_blockers_absent}|breakglass_closed={state.break_glass_incidents_closed}|"
        f"patch_validated={state.temporary_patch_validation_closed}|review_auth={state.final_reviewer_authorized_reads_complete}|"
