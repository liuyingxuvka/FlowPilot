"""FlowGuard development-process model for the clean AI project runtime."""
...
MODEL_ID = "ai_project_runtime_development_process"
...
class DevelopmentStep:
    name = "AIProjectRuntimeDevelopmentStep"
    reads = (
        "openspec_validated",
...
INVARIANTS = (
    Invariant(
        name="ai_project_runtime_development_order",
        description=(
