...
REQUIRED_LABELS = (
    ...
    "select_startup_mechanical_audit_field_mismatch",
    ...
    "select_startup_mechanical_audit_hash_alias",
    "select_cockpit_missing_host_receipt",
    "select_display_manual_receipt_after_pm_startup_intake",
    "select_startup_repair_dedupes_current_blocker",
    "select_role_output_envelope_ambiguity",
    "select_retired_material_authority_reintroduced",
    "select_shallow_skill_inventory_contract_missing",
    "select_complete_workstream_report_contract_missing",
    ...
    "router_rejects_startup_mechanical_audit_field_mismatch",
    ...
    "router_rejects_startup_mechanical_audit_hash_alias",
    "router_rejects_cockpit_missing_host_receipt",
    "router_rejects_display_manual_receipt_after_pm_startup_intake",
    "router_rejects_startup_repair_dedupes_current_blocker",
    "router_rejects_role_output_envelope_ambiguity",
    "router_rejects_retired_material_authority_reintroduced",
    "router_rejects_shallow_skill_inventory_contract_missing",
    "router_rejects_complete_workstream_report_contract_missing",
...
HAZARD_EXPECTED_FAILURES = {
    "startup_mechanical_audit_field_mismatch": "startup_intake_receipt_envelope_hash_current",
    ...
    "startup_mechanical_audit_hash_alias": "role guidance can alias the router-owned startup mechanical audit path",
    "cockpit_missing_host_receipt": "cockpit requested without host receipt",
    "display_manual_receipt_after_pm_startup_intake": "manual display receipt is unavailable before PM startup intake",
    "startup_repair_dedupes_current_blocker": "startup repair event is deduped by a one-shot flag",
    "role_output_envelope_ambiguity": "role output guidance omits exact path/hash pairs",
    "retired_material_authority_reintroduced": "retired material_scan/material_sufficiency/material_understanding authority is active",
    "shallow_skill_inventory_contract_missing": "mandatory shallow local skill inventory contract is missing",
    "complete_workstream_report_contract_missing": "numbered complete-workstream report rows",
...
def _check_current_source() -> dict[str, object]:
    ...
    return {
        ...
        "facts": {
            ...
            "router_writes_startup_mechanical_audit": state.router_writes_startup_mechanical_audit,
            "startup_role_may_alias_runtime_audit_path": state.startup_role_may_alias_runtime_audit_path,
            "router_forbids_runtime_audit_alias": state.router_forbids_runtime_audit_alias,
            "display_status_available_before_pm_startup_intake": state.display_status_available_before_pm_startup_intake,
            ...
            "retired_material_authority_absent": state.retired_material_authority_absent,
            "mandatory_shallow_skill_inventory_contract_present": state.mandatory_shallow_skill_inventory_contract_present,
            "complete_workstream_report_contract_present": state.complete_workstream_report_contract_present,
