...
MARKER_REQUIREMENTS: tuple[Mapping[str, Any], ...] = (
    ...
    },
    {
        ...
        "markers": (
            ...
            "contract_self_check",
            "_flowguard_packet_artifact_hard_decision",
    ...
    },
    {
        ...
        "markers": (
            ...
            "test_flowguard_packet_block_with_compact_blocker_does_not_issue_reviewer",
        ),
        "covers": (OBL_FLOWGUARD_EVIDENCE_CONSISTENCY,),
    },
    {
    ...
    },
    {
        ...
        "markers": (
            ...
            "`passed: false`",
            "`blockers[]`",
            "packet-owned evidence",
        ),
        "covers": (OBL_FLOWGUARD_EVIDENCE_CONSISTENCY,),
    },
    {
        "requirement_id": "runtime.stage_evidence_matrix_source",
    ...
    {
        "requirement_id": "runtime.stage_evidence_matrix_handoff",
        "path": "skills/flowpilot/assets/flowpilot_core_runtime/runtime.py",
        "markers": (
            "_packet_stage_evidence_row",
            "subject_stage_evidence_matrix",
            "Do not block",
            "moved/deleted or future",
            "stage_evidence_matrix",
        ),
        "covers": (OBL_STAGE_EVIDENCE_MATRIX,),
    },
    {
        "requirement_id": "card.stage_evidence_matrix_roles",
        "path": "skills/flowpilot/assets/runtime_kit/cards/roles/flowguard_operator.md",
        "markers": (
            "subject_stage_evidence_matrix",
            "current_required_fields",
            "deleted_fields",
            "post-result FlowGuard evidence",
        ),
        "covers": (OBL_STAGE_EVIDENCE_MATRIX,),
    },
    {
        "requirement_id": "card.stage_evidence_matrix_reviewer",
        "path": "skills/flowpilot/assets/runtime_kit/cards/roles/human_like_reviewer.md",
        "markers": (
            "subject_stage_evidence_matrix",
            "current_required_fields",
            "deleted_fields",
            "post-result FlowGuard",
        ),
        "covers": (OBL_STAGE_EVIDENCE_MATRIX,),
    },
    {
        "requirement_id": "runtime.portable_self_check_source",
        "path": "skills/flowpilot/assets/flowpilot_runtime_self_check.py",
        "markers": (
            "REQUIRED_RUNTIME_ASSETS",
            "dev_repo_simulations_required",
            "write_runtime_self_check_receipt",
            "importlib.metadata.version",
        ),
        "covers": (OBL_RUNTIME_SELF_CHECK,),
    },
    {
        "requirement_id": "runtime.portable_self_check_start_run",
        "path": "skills/flowpilot/assets/flowpilot_new_shared.py",
        "markers": (
            "_record_runtime_self_check_receipt",
            "flowpilot_runtime_self_check",
