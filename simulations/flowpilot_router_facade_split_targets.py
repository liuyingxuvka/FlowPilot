...
ROUTER_FACADE_TARGET_RATIONALES = {
    ...
    "facade_export_manifest": "Keeps the unsupported_historical owner-export manifest import path as a unsupported_historical aggregator.",
    "facade_export_registry": "Owns the canonical owner-export registry rows and derived domain views.",
    "facade_export_manifest_actions": "Keeps the action-domain owner-export unsupported_historical view.",
    "facade_export_manifest_controller": "Keeps the controller-domain owner-export unsupported_historical view.",
    "facade_export_manifest_route": "Keeps the route-domain owner-export unsupported_historical view.",
    "facade_export_manifest_startup": "Keeps the startup-domain owner-export unsupported_historical view.",
    "facade_export_manifest_terminal_work": "Keeps the terminal and work-packet owner-export unsupported_historical view.",
    "cli": "Owns command parsing and CLI JSON/error envelope behavior.",
    "controller_runtime": "Keeps the high-level next/apply/event controller loop exports bound to the router facade.",
    "controller_runtime_loop": "Keeps controller runtime loop facade exports bound to focused next/apply child owners.",
    "controller_runtime_next": "Owns next-action selection and legal Controller action computation.",
    "controller_runtime_apply": "Owns apply, event intake, controller receipt, and foreground run-until-wait folding.",
    ...
    "lifecycle_support": "Owns legacy Router wake binding and lifecycle support helpers moved out of the skeleton.",
    ...
    "prompt_delivery": "Owns prompt-backed delivery text used by cards, controller tables, and legacy Router startup wake prompts.",
    ...
    "router_io": "Keeps the low-level router IO unsupported_historical facade without retaining behavior bodies.",
    "router_io_paths": "Owns UTC, runtime-kit, bootstrap-state, project-relative, and runtime-entrypoint path helpers.",
    "router_io_locks": "Owns runtime JSON write-lock liveness, takeover, cleanup, and writer-settlement behavior.",
    "router_io_json": "Owns atomic runtime JSON writes and JSON read variants.",
    "router_io_hashes": "Owns JSON and role-output semantic hash helpers.",
    ...
    "startup_role_recovery": "Owns legacy Router resume, role assignment/replacement support, role open normalization, and continuation binding records.",
    "startup_closure": "Owns startup closure reconciliation and legacy Router wake-binding readiness checks.",
    "startup_mechanical_boundary": "Owns startup fact audit, controller-boundary confirmation, and mechanical-audit repair actions.",
    ...
    "action_handlers_roles": "Keeps role-facing action handler exports grouped for the action registry.",
    "action_handlers_role_binding": "Owns current role-agent binding and role I/O protocol injection action bodies.",
    "action_handlers_role_misc": "Owns role-facing mail delivery, repair work packet, display, and blocker action bodies.",
    "action_handlers_resume": "Owns resume and role-recovery controller-action handler bodies.",
    ...
    "lifecycle_requests": "Keeps the lifecycle request unsupported_historical facade and binds focused child owners.",
    "lifecycle_requests_fence": "Owns terminal daemon and controller-work fencing for user stop/cancel requests.",
    "lifecycle_requests_reconciliation": "Owns terminal authority reconciliation and stale control-blocker clearance.",
    "lifecycle_requests_records": "Owns run lifecycle records, protocol dead-end records, and terminal lifecycle actions.",
    "lifecycle_requests_blockers": "Owns exception-to-control-blocker fallback materialization.",
...
ROUTER_FACADE_FUNCTION_BLOCK_MAP = (
    ...
    ("owner_export_registry", "facade_export_registry"),
    ("owner_export_manifest", "facade_export_manifest"),
    ...
    ("parse_args", "cli"),
    ("main", "cli"),
    ("next_action", "controller_runtime_next"),
    ("apply_action", "controller_runtime_apply"),
    ("apply_controller_action", "controller_runtime_apply"),
    ("record_external_event", "controller_runtime_apply"),
    ("run_until_wait", "controller_runtime_apply"),
    ("record_controller_action_receipt", "controller_runtime_apply"),
    ("controller_runtime_next", "controller_runtime_next"),
    ("controller_runtime_apply", "controller_runtime_apply"),
    ...
    ("startup_lifecycle_resume_prompt", "prompt_delivery"),
    ...
    ("router_io_facade", "router_io"),
    ("router_io_paths", "router_io_paths"),
    ("runtime_json_write_locks", "router_io_locks"),
    ("runtime_json_reads_writes", "router_io_json"),
    ("role_output_hashing", "router_io_hashes"),
    ...
    ("startup_mechanical_boundary", "startup_mechanical_boundary"),
    ...
    ("action_handlers_roles", "action_handlers_roles"),
    ("action_handlers_role_binding", "action_handlers_role_binding"),
    ("action_handlers_role_misc", "action_handlers_role_misc"),
    ("action_handlers_resume", "action_handlers_resume"),
    ...
    ("lifecycle_request_facade", "lifecycle_requests"),
    ("terminal_controller_work_fence", "lifecycle_requests_fence"),
    ("terminal_lifecycle_reconciliation", "lifecycle_requests_reconciliation"),
    ("run_lifecycle_records", "lifecycle_requests_records"),
    ("protocol_dead_end_lifecycle", "lifecycle_requests_records"),
    ("exception_blocker_fallback", "lifecycle_requests_blockers"),
