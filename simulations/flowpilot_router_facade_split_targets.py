...
ROUTER_FACADE_TARGET_RATIONALES = {
    ...
    "facade_export_manifest": "Keeps the legacy owner-export manifest import path as a compatibility aggregator.",
    "facade_export_registry": "Owns the canonical owner-export registry rows and derived domain views.",
    "facade_export_manifest_actions": "Keeps the action-domain owner-export compatibility view.",
    "facade_export_manifest_controller": "Keeps the controller-domain owner-export compatibility view.",
    "facade_export_manifest_route": "Keeps the route-domain owner-export compatibility view.",
    "facade_export_manifest_startup": "Keeps the startup-domain owner-export compatibility view.",
    "facade_export_manifest_terminal_work": "Keeps the terminal and work-packet owner-export compatibility view.",
    ...
    "router_io": "Keeps the low-level router IO compatibility facade without retaining behavior bodies.",
    ...
    "lifecycle_requests": "Keeps the lifecycle request compatibility facade and binds focused child owners.",
