...
def source_code_contracts() -> tuple[CodeContract, ...]:
    ...
    return (
        ...
        _contract(
            ...
            external_inputs=("name", "command", "log_root", "timeout_seconds", "source_fingerprint_value"),
            external_outputs=("exit_code",),
            side_effects=("write", "write_text"),
        ),
        _contract(
        ...
        _contract(
            ...
            implements=("current_contract.same_source_fingerprint",),
