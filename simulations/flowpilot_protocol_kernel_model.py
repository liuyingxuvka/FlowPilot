"""FlowGuard model for the clean FlowPilot protocol kernel."""
...
MODEL_ID = "flowpilot_protocol_kernel_kernel"
...
INVARIANTS = (
    Invariant(
        "flowpilot_protocol_kernel_completion_gate",
...
class FlowPilotProtocolStep:
    """Input x State -> Set(Output x State) for the FlowPilot protocol."""

    name = "FlowPilotProtocolStep"
    reads = (
        "black_box_ledger",
        "agent_lease",
        "task_packet",
    ...
    input_description = "protocol event or deterministic actor scenario"
...
def build_workflow() -> Workflow:
    return Workflow((FlowPilotProtocolStep(),), name=MODEL_ID)
