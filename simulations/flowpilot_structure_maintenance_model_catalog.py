...
MODEL_STRUCTURE_MODULES = (
    ModuleStructureEvidence(
        ...
        behavior_contracts=("unsupported_historical import path", "runner unsupported_historical"),
    ...
    ModuleStructureEvidence(
        ...
        behavior_contracts=("unsupported_historical packet control-plane model import path", "runner unsupported_historical"),
        behavior_parity_tier=EVIDENCE_CONFORMANCE_GREEN,
        release_required=True,
    ),
    ModuleStructureEvidence(
