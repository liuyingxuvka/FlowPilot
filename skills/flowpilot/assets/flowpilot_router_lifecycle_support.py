"""Router skeleton owner helpers for flowpilot_router_lifecycle_support.
...
OWNER_MODULE = 'flowpilot_router_lifecycle_support'
...
def _reset_resume_cycle_for_wakeup(run_state: dict[str, Any]) -> None:
    flowpilot_router_resume.reset_resume_cycle_for_wakeup(_bound_router(), run_state)
