"""External event route shard for the FlowPilot router protocol."""

from __future__ import annotations

from typing import Any

EXTERNAL_EVENTS_ROUTE: dict[str, dict[str, Any]] = {'pm_writes_route_draft': {'flag': 'route_draft_written_by_pm',
