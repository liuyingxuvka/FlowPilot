...
ALLOWED_VALUE_OPTIONS_BY_FAMILY: dict[str, dict[str, tuple[Any, ...]]] = {
    ...
    "task.parent_backward_replay": {
        "composition_decision": COMMON_PASS_BLOCK_DECISION_OPTIONS,
        "blockers[].blocker_class": ALLOWED_BLOCKER_CLASSES_BY_FAMILY["task.parent_backward_replay"],
    },
    "flowguard_check.post_result": {
...
PACKET_STAGE_EVIDENCE_MATRIX: tuple[dict[str, Any], ...] = tuple(
    {
        ...
        "lifecycle_stage": {
            ...
            "task.parent_backward_replay": "parent_composition_replay",
        ...
        "required_evidence_owner": {
            ...
            "task.parent_backward_replay": "flowpilot_parent_replay",
