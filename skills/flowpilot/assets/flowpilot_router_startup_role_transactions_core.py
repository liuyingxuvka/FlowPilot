...
def _role_recovery_payload_contract(router: ModuleType, run_root: Path, run_state: dict[str, Any], transaction: dict[str, Any]) -> dict[str, Any]:
    ...
    required_fields = ['background_agents_capability_status', 'recovery_transaction_id', 'trigger_source', 'recovery_scope', 'target_role_keys', 'recovered_role_agents[].role_key', 'recovered_role_agents[].agent_id', 'recovered_role_agents[].model_policy', 'recovered_role_agents[].reasoning_effort_policy', 'recovered_role_agents[].recovery_result', 'recovered_role_agents[].restore_attempted', 'recovered_role_agents[].restore_result', 'recovered_role_agents[].host_liveness_status', 'recovered_role_agents[].liveness_decision', 'recovered_role_agents[].rehydrated_for_run_id', 'recovered_role_agents[].memory_context_injected', 'recovered_role_agents[].packet_ownership_reconciled']
    if scope == 'targeted':
