"""Startup mechanical checks for ``flowpilot_router_startup_fact_boundary``.
...
def _startup_mechanical_checks(router: ModuleType, project_root: Path, run_root: Path, run_state: dict[str, Any]) -> dict[str, bool]:
    ...
    return {
        ...
        'runtime_uses_startup_intake_record_as_sealed_input': bool(startup_intake_context and startup_intake_context.get('reviewer_must_not_use_chat_history')),
