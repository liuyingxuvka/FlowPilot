...
def _write_terminal_closure_suite(router: ModuleType, project_root: Path, run_root: Path, run_state: dict[str, Any], payload: dict[str, Any]) -> None:
    ...
    required_paths = [final_ledger_path, terminal_replay_path, task_projection_path, run_root / 'execution_frontier.json', run_root / 'role_binding_ledger.json', continuation_path]
