    ...
    *,
    ...
    if lane == "control_plane_reissue":
        _validate_control_transaction_requirements(
            ...
            required_event_usages=("wait",),
            required_commit_targets=("blocker_index", "run_state", "status_summary"),
...
def _write_control_blocker_repair_decision(project_root: Path, run_root: Path, run_state: dict[str, Any], payload: dict[str, Any]) -> None:
    ...
    control_transaction = _validate_control_transaction_requirements(
        ...
        output_contract_id="flowpilot.output_contract.pm_control_blocker_repair_decision.v1",
        router_events=(
            PM_CONTROL_BLOCKER_REPAIR_DECISION_EVENT,
            PM_CONTROL_BLOCKER_FOLLOWUP_BLOCKER_EVENT,
            PM_CONTROL_BLOCKER_PROTOCOL_BLOCKER_EVENT,
        ),
        required_event_usages=("recorded_event", "rerun_target", "repair_outcome"),
        required_commit_targets=("repair_transaction", "blocker_index", "run_state", "status_summary"),
        require_repair_transaction=True,
