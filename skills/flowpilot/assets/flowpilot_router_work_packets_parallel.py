...
import flowpilot_router_work_packets_parallel_reconciliation as _parallel_reconciliation
from flowpilot_router_work_packets_parallel_reconciliation import *
...
def _bind_router(router: ModuleType) -> None:
    ...
    for name, value in vars(router).items():
        ...
        if name in local_names:
            continue
        current[name] = value
    _parallel_reconciliation._bind_router(router)
