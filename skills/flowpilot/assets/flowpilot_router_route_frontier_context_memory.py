...
def _refresh_route_memory(router: ModuleType, project_root: Path, run_root: Path, run_state: dict[str, Any], *, trigger: str) -> None:
    ...
    reviewer_blocks = _event_markers(router, run_state, {'current_node_reviewer_blocks_result', 'reviewer_blocks_node_acceptance_plan', 'reviewer_reports_material_insufficient', 'router_direct_material_scan_dispatch_recheck_blocked'})
    reviewer_passes = _event_markers(router, run_state, {'reviewer_reports_material_sufficient', 'reviewer_passes_research_direct_source_check', 'reviewer_passes_node_acceptance_plan', 'current_node_reviewer_passes_result', 'reviewer_passes_parent_backward_replay', 'reviewer_passes_evidence_quality_package', 'reviewer_final_backward_replay_passed'})
