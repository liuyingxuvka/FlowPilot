...
def _refresh_route_memory(router: ModuleType, project_root: Path, run_root: Path, run_state: dict[str, Any], *, trigger: str) -> None:
    ...
    reviewer_blocks = router._event_markers(run_state, {'current_node_reviewer_blocks_result', 'reviewer_blocks_node_acceptance_plan', 'reviewer_reports_material_insufficient', 'router_direct_material_scan_dispatch_recheck_blocked'})
