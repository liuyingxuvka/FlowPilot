...
EXTERNAL_EVENT_DATA_BY_PHASE: dict[str, dict[str, dict[str, Any]]] = {
    'startup':     {'user_requests_run_stop': {'flag': 'run_stopped_by_user',
     ...
     'pm_declares_startup_protocol_dead_end': {'flag': 'startup_protocol_dead_end_declared',
                                               ...
                                               'summary': 'PM declared that the startup block has no '
                                                          ...
                                                          'and stopped the run.'}},
    'material':     {'pm_issues_material_and_capability_scan_packets': {'flag': 'pm_material_packets_issued',
    ...
    'terminal':     {'pm_records_evidence_quality_package': {'flag': 'evidence_quality_package_written',
